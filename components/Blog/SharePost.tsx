...
const SharePost = ({ title = "", url = "" }: SharePostProps) => {
  // Usa o URL atual se nenhum for fornecido
  const shareUrl = url || (typeof window !== 'undefined' ? window.location.href : '');
  const shareTitle = title || 'Tududone - Remodelação de Apartamentos';
  ...
  return (
    <div className="mt-11 flex flex-wrap gap-4 md:items-center md:justify-between md:gap-0">
      <ul className="flex items-center gap-6">
        <li>
          <p className="text-black dark:text-white">Compartilhar:</p>
        </li>
        <li>
          <a 
